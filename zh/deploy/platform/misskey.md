...
![创建 Misskey 平台适配器](https://files.astrbot.app/docs/docs/source/images/misskey/create.png)
...
![Misskey 平台适配器配置](https://files.astrbot.app/docs/docs/source/images/misskey/config.png)
...
![打开 Misskey 连接服务页面](https://files.astrbot.app/docs/docs/source/images/misskey/pat-1.png)

2. 单击“生成访问令牌”以生成账号接入访问令牌。

![生成 Misskey 账号令牌](https://files.astrbot.app/docs/docs/source/images/misskey/pat-2.png)
...
![配置访问令牌权限](https://files.astrbot.app/docs/docs/source/images/misskey/pat-3.png)
...
![查看账号令牌](https://files.astrbot.app/docs/docs/source/images/misskey/pat-4.png)
...
![效果示例](https://files.astrbot.app/docs/docs/source/images/misskey/demo.png)
...
![这是一个机器人账号](https://files.astrbot.app/docs/docs/source/images/misskey/botset.png)
