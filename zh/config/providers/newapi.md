...
![create-api-key](https://files.astrbot.app/docs/docs/source/images/newapi/image.png)

创建成功后，点击复制密钥按钮，复制生成的 API Key 密钥。

![copy-api-key](https://files.astrbot.app/docs/docs/source/images/newapi/image-1.png)
...
![astrbot-provider-config](https://files.astrbot.app/docs/docs/source/images/newapi/image-2.png)
...
![apply](https://files.astrbot.app/docs/docs/source/images/newapi/image-3.png)
